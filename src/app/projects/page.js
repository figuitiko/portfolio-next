...
const Projects = () => {
  return (
    <div className='flex flex-wrap gap-1 wrapper-home  overflow-y-scroll max-h-[800px] custom-scrollbar overflow-x-hidden animate-in fade-in duration-500 animate-twice ease-in '>
